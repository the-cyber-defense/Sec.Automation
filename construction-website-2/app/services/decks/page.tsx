  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">Recent Deck Construction Projects</h2>
            <p className="text-lg text-gray-700 max-w-3xl mx-auto">
              See how we transform outdoor spaces with custom deck construction and thoughtful design.
            </p>
          </div>
          
          {/* Before/After Project 1 */}
          <div className="max-w-6xl mx-auto mb-16">
            <h3 className="text-2xl font-bold text-center mb-8">Custom Multi-Level Deck Construction</h3>
          ...
          <div className="max-w-6xl mx-auto">
            <h3 className="text-2xl font-bold text-center mb-8">Composite Deck with Custom Railings</h3>
            <div className="grid md:grid-cols-2 gap-8">
              <div className="relative">
                <h4 className="text-lg font-semibold mb-4 text-center">Before</h4>
                <div className="relative h-[300px] md:h-[400px] rounded-2xl overflow-hidden shadow-xl">
                  <Image
                    src="/images/project26.png"
                    alt="Before composite deck installation"
                    fill
                    className="object-cover"
                    sizes="(max-width: 768px) 100vw, 50vw"
                  />
              ...
              <div className="relative">
                ...
                <div className="relative h-[300px] md:h-[400px] rounded-2xl overflow-hidden shadow-xl">
                  <Image
                    src="/images/project27.png"
                    alt="After composite deck installation"
                    fill
                    className="object-cover"
                    sizes="(max-width: 768px) 100vw, 50vw"
                  />
