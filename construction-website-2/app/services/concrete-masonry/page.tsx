  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">Recent Concrete & Masonry Projects</h2>
            <p className="text-lg text-gray-700 max-w-3xl mx-auto">
              See the quality and craftsmanship we bring to every concrete and masonry project.
            </p>
          </div>
          
          {/* Before/After Project 1 */}
          <div className="max-w-6xl mx-auto mb-16">
            <h3 className="text-2xl font-bold text-center mb-8">Residential Concrete Patio Installation</h3>
            <div className="grid md:grid-cols-2 gap-8">
              <div className="relative">
                ...
                <div className="relative h-[300px] md:h-[400px] rounded-2xl overflow-hidden shadow-xl">
                  <Image
                    src="/images/project8.png"
                    alt="Before concrete patio installation"
                    fill
                    className="object-cover"
              ...
              <div className="relative">
                ...
                <div className="relative h-[300px] md:h-[400px] rounded-2xl overflow-hidden shadow-xl">
                  <Image
                    ...
                    alt="After concrete patio installation"
                    fill
                    className="object-cover"
                    sizes="(max-width: 768px) 100vw, 50vw"
                  />
          ...
          <div className="max-w-6xl mx-auto">
            <h3 className="text-2xl font-bold text-center mb-8">Stone Retaining Wall & Masonry Work</h3>
            <div className="grid md:grid-cols-2 gap-8">
              <div className="relative">
                <h4 className="text-lg font-semibold mb-4 text-center">Before</h4>
                <div className="relative h-[300px] md:h-[400px] rounded-2xl overflow-hidden shadow-xl">
                  <Image
                    ...
                    alt="Before masonry retaining wall construction"
                    fill
                    className="object-cover"
                    sizes="(max-width: 768px) 100vw, 50vw"
                  />
              ...
              <div className="relative">
                ...
                <div className="relative h-[300px] md:h-[400px] rounded-2xl overflow-hidden shadow-xl">
                  <Image
                    ...
                    alt="After masonry retaining wall construction"
                    fill
                    className="object-cover"
                    sizes="(max-width: 768px) 100vw, 50vw"
                  />
